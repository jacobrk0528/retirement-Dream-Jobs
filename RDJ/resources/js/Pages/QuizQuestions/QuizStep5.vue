                ...
                <form>
                    <label>
                        <input
                            ...
                            name="option"
                            :value= option1
                            :checked = "question5Answer === option1"
                    ...
                    <label>
                        <input
                            ...
                            name="option"
                            :value= option2
                            :checked = "question5Answer === option2"
                    ...
                    <label>
                        <input
                            ...
                            name="option"
                            :value= option3
                            :checked = "question5Answer === option3"
...
export default {
    ...
    data() {
        return {
            ...
            option2: 'option 2',
            option3: 'option 3',
            question5Answer: this.getAnswer()
        }
    },
    methods: {
        updateAnswer(answer) {
        ...
        getAnswer() {
            ...
            .then(response => {
                console.log(response);
                this.question5Answer = response.data;
            })
            .catch(error => {
                console.log(error);
            });
