                ...
                <form>
                    <label>
                        <input
                            ...
                            name="option"
                            :value= option1
                            :checked = "question4Answer === option1"
                    ...
                    <label>
                        <input
                            ...
                            name="option"
                            :value= option2
                            :checked = "question4Answer === option2"
                    ...
                    <label>
                        <input
                            ...
                            name="option"
                            :value= option3
                            :checked = "question4Answer === option3"
...
export default {
    ...
    data() {
        return {
            ...
            option2: 'option 2',
            option3: 'option 3',
            question4Answer: this.getAnswer()
        }
    },
    methods: {
        updateAnswer(answer) {
        ...
        getAnswer() {
            ...
            .then(response => {
                console.log(response);
                this.question4Answer = response.data;
            })
            .catch(error => {
                console.log(error);
            });
